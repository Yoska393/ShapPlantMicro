...
if (cd == "Drought"){
	saveRDS(str.diff,here("out","str.diff_d2.rds"))
} else if (cd=="Control"){
	saveRDS(str.diff,here("out","str.diff_c2.rds"))
} else {
	stop()
}
...
if (cd == "Drought"){
	str.diff<- readRDS(here("out","str.diff_d2.rds"))
} else if (cd=="Control"){
	str.diff<- readRDS(here("out","str.diff_c2.rds"))
} else {
	stop()
}
