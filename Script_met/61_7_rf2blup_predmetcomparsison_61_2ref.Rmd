---
title: "61_7_rf2blup_predmetcomparsison_61_2ref"
...
KZ1_8<- list(A= list(K = K1, Z = Z),B= list(K = K8, Z = Z))
KZ1_9<- list(A= list(K = K1, Z = Z),B= list(K = K9, Z = Z))
KZ1_11<- list(A= list(K = K1, Z = Z),B= list(K = K11, Z = Z))
KZ1_12<- list(A= list(K = K1, Z = Z),B= list(K = K12, Z = Z))
...
```{r}
ZETAlist <- list(KZ1_2_8=KZ1_2_8,
                 KZ1_2_11=KZ1_2_11)
tic()
res_bpred<- getBLUP_simple(ZETAlist,y)
toc()
saveRDS(res_bpred, here("out", paste0("yPredYield_BLUP_", CD, "com_bpred_gm.RDS")))


ZETAlist <- list(KZ1_2_9=KZ1_2_9,
                 KZ1_2_12=KZ1_2_12)
tic()
res_bpred<- getBLUP_simple(ZETAlist,y)
toc()
saveRDS(res_bpred, here("out", paste0("yPredYield_BLUP_", CD, "com_bpred_gm_912.RDS")))
```
...
```{r}
#KZ1_2_8<- list(A= list(K = K1[1:5,1:5], Z = Z[1:5,1:5]),B= list(K = K2[1:5,1:5], Z = Z[1:5,1:5]),C= list(K = K8[1:5,1:5], Z = Z[1:5,1:5]))

#d <- getBLUP(ZETAlist,y2[1:5,1:5])
...
tic()
res_bpred_b1 <- getBLUP_ab(ZETAlist,y2,B =met19.cd,Bpred = predmet19,re=3)
toc()
saveRDS(res_bpred_b1, here("out", paste0("yPredYield_BLUP_", CD, "com_bpred_b1_gm.RDS")))

ZETAlist <- list(KZ1_2_11=KZ1_2_11)

tic()
res_bpred_b2 <- getBLUP_ab(ZETAlist,y2,B =met19.cd,Bpred = predmet19RF,re=3)
toc()
saveRDS(res_bpred_b2, here("out", paste0("yPredYield_BLUP_", CD, "com_bpred_b2_gm.RDS")))
...
res_bpred_b1 <- getBLUP_ab(ZETAlist,y2,B =met19.cd,Bpred = predmet19,re=3)
toc()
saveRDS(res_bpred_b1, here("out", paste0("yPredYield_BLUP_", CD, "com_bpred_b9_gm.RDS")))

ZETAlist <- list(KZ1_2_12=KZ1_2_12)

tic()
res_bpred_b2 <- getBLUP_ab(ZETAlist,y2,B =met19.cd,Bpred = predmet19RF,re=3)
toc()
saveRDS(res_bpred_b2, here("out", paste0("yPredYield_BLUP_", CD, "com_bpred_b12_gm.RDS")))
