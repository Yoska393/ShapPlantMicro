...
if (CD == "W4"){
  ...
  RF <- readRDS(here("out", "19f19_predMet_RF_OneOut_W4.rds")) #com
...
saveRDS(res, here("out", paste0("yPredYield_RF_", CD, "rm.RDS")))

```
# read 
```{r}
res<-readRDS(here("out", paste0("yPredYield_RF_", CD, "rm.RDS")))
```
