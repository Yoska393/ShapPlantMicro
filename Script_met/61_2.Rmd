...
K1_2   <- list(K1=K1,K2=K2)
K1_2_8 <- list(K1=K1,K2=K2,K8=K8)
K1_2_9 <- list(K1=K1,K2=K2,K9=K9)
K1_2_11<- list(K1=K1,K2=K2,K11=K11)
K1_2_12<- list(K1=K1,K2=K2,K12=K12)
K1_2_3 <- list(K1=K1,K2=K2,K3=K3)

ZETAlist <- list(K1,K2,K3,K8,K9,K11,K1_2,K1_2_8,K1_2_9,K1_2_11,K1_2_12,K1_2_3)
```
...
saveRDS(res, here("out", paste0("yPredYield_RF_", CD, "com.RDS")))

```
# read 
```{r}
res<-readRDS(here("out", paste0("yPredYield_RF_", CD, "com.RDS")))
```
