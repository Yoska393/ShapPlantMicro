...
library(doSNOW)
library(purrr)
source(here("Script/MyFunctions.R"))
# library(vegan)
# library(VARshrink)
# library(ggplot2)
# library(glmnet)
...
saveRDS(y.pred.list, here("out", paste0("yPredMet_RF_countmicro_3k", "W1", ".RDS")))
```


```{r}

set<- readRDS(here("out", paste0("yPredMet_RF_countmicro_3kW1.RDS")))
#yPredMet_RF<- readRDS("~/Documents/R/HayatoINRAE/out/yPredMet_RF_countmicro_W1.RDS")
pred <- vector("list", 2)
...
saveRDS(pred, here("out", paste0("19f19_predMet_RF_countmicro3k", "_W1", ".RDS")))
```
