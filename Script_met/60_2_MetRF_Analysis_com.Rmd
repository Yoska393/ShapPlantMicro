...
# RF hist
```{r}
set<- readRDS(here("out", paste0("yPredMet_RF_", "W1", "com.RDS")))
```
...
#boxplot(accu, main = paste(toupper(colnames(accu)[i]),"model"),xlab="COR",ylim =c(-0.5,0.7),col="cornflowerblue")
...
```{r}
##saveRDS(pred, here("out", paste0("19f19_predMet_RF_OneOut", "_W1", "com.RDS")))
```
...
# RF hist
```{r}
set<- readRDS(here("out", paste0("yPredMet_RF_", "W4", "19f20","com.RDS")))
```
...
for(i in 1:ncol(accu)) {
  hist(accu[,i], main = paste(toupper(colnames(accu)[i]), "model"),
       breaks = seq(-1.0, 1.0, 0.1),xlab="COR",ylim = c(0,120),col="coral", cex.main=2,cex.lab=2,cex.axis=2)
  abline(v = median(accu[,i]),                       # Add line for mean
       col = "darkgreen",
       lwd = 3)  
  legend(x = "topright", # location of legend within plot area
...
```{r}
##saveRDS(pred, here("out", paste0("19f20_predMet_RF_OneOut", "_W4", "com.RDS")))
```
...
# RF hist
```{r}
set<- readRDS(here("out", paste0("yPredMet_RF_", "W1", "19f20","com.RDS")))
```
...
for(i in 1:ncol(accu)) {
  hist(accu[,i], main = paste(toupper(colnames(accu)[i]), "model"),
       breaks = seq(-1.0, 1.0, 0.1),xlab="COR",ylim = c(0,120),col="cornflowerblue",cex.main=2,cex.lab=2,cex.axis=2)
  abline(v = median(accu[,i]),                       # Add line for mean
       col = "darkgreen",
       lwd = 3)  
  legend(x = "topright", # location of legend within plot area
...
```{r}
##saveRDS(pred, here("out", paste0("19f20_predMet_RF_OneOut", "_W1", "com.RDS")))
```
...
```{r}
mlist <- list(idr,idb,icr,icb,tdr,tdb,tcr,tcb)
