...
ZETAlist <- list(KZ1,KZ3,KZ8,KZ9,KZ11,KZ12,KZ1_8,KZ1_9,KZ1_11,KZ1_12,KZ1_3)
names(ZETAlist) <- c("KZ1","KZ3","KZ8","KZ9","KZ11","KZ12","KZ1_8","KZ1_9","KZ1_11","KZ1_12","KZ1_3")
...
toc()
saveRDS(res, here("out", paste0("yPredYield_BLUPwRF_", CD, "com_g.RDS")))
...
res<-readRDS(here("out", paste0("yPredYield_BLUPwRF_", CD, "com_g.RDS")))
p<-res$p
pred.all<-res$resultEachModel

model.name <- c("KZ1","KZ3","KZ8","KZ9","KZ11","KZ12","KZ1_8","KZ1_9","KZ1_11","KZ1_12","KZ1_3")
