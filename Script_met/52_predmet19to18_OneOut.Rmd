---
title: "52_predmet19to18_OneOut"
author: "Hayato Yoshioka"
date: "2023-05-29"
output: html_document
---

Inter year prediction by BLUP   
We tried the following models     
- G -> Met  (2019->2018)  
- G + Micro -> Met (2019->2018)  
- G + Micro -> Met (2018->2018)  
...
```{r}
pheno18 <- read.csv(here("data", "shoot_blup_all_2018.csv"), row.names = 1)
...
```{R,eval = FALSE}
write.csv(predmetgm,here("2020","20f19_predmet_GM_blup_OneOut.csv"))
```
...
csv
```{R,eval = FALSE}
write.csv(predmetg,here("2020","20f19_predmet_G_blup_OneOut.csv"))
```
...
csv
```{R,fig.dim = c(5,3)}
write.csv(predmetg,here("2020","20f20_predmet_G_blup_OneOut.csv"))
```


### hist (G->Met)  (2019->2020)
```{R,fig.dim = c(5,3)}
pm20f19g<- read.csv(here("2020","20f19_predmet_G_blup_OneOut.csv"),row.names = 1)
cor<- cor(pm20f19g,met20.cd)
Predmet_20from19_COR_G<- diag(cor)
hist(Predmet_20from19_COR_G,xlim =c(-1,1),ylim=c(0,100),breaks=20,xlab = "COR")
```

### hist (G + Micro -> Met) (2019->2020)
```{R,fig.dim = c(5,3)}
pm20f19<- read.csv(here("2020","20f19_predmet_GM_blup_OneOut.csv"),row.names = 1)
cor<- cor(pm20f19,met20.cd)
Predmet_20from19_COR_GM<- diag(cor)
hist(Predmet_20from19_COR_GM,xlim =c(-1,1),ylim=c(0,100),breaks=5,xlab = "COR")
```


### hist (G + Micro -> Met) (2020->2020)
```{R,fig.dim = c(5,3)}
predmet20 <- read.csv(here("2020", "2020_predmet_blup.csv"), row.names = 1)
cor<- cor(predmet20,met20.cd)
Predmet_20from20_COR_GM<- diag(cor)
hist(Predmet_20from20_COR_GM,xlim =c(-1,1),ylim=c(0,100),breaks=20,xlab = "COR")
```
...
```{R,eval = FALSE}
write.csv(predmetgm,here("2020","20f19_predmet_GM_blup_OneOut_c.csv"))
```
...
csv
```{R,eval = FALSE}
write.csv(predmetg,here("2020","20f19_predmet_G_blup_OneOut_c.csv"))
```
...
csv
```{R,fig.dim = c(5,3)}
write.csv(predmetg,here("2020","20f20_predmet_GM_blup_OneOut_c.csv"))
```


### hist (G->Met)  (2019->2020)
```{R,fig.dim = c(5,3)}
pm20f19g<- read.csv(here("2020","20f19_predmet_G_blup_OneOut_c.csv"),row.names = 1)
cor<- cor(pm20f19g,met20.cd)
Predmet_20from19_COR_G_C<- diag(cor)
hist(Predmet_20from19_COR_G_C,xlim =c(-1,1),ylim=c(0,100),breaks=10,xlab = "COR")
```

### hist (G + Micro -> Met) (2019->2020)
```{R,fig.dim = c(5,3)}
pm20f19<- read.csv(here("2020","20f19_predmet_GM_blup_OneOut_c.csv"),row.names = 1)
cor<- cor(pm20f19,met20.cd)
Predmet_20from19_COR_GM_C<- diag(cor)
hist(Predmet_20from19_COR_GM_C,xlim =c(-1,1),ylim=c(0,100),breaks=10,xlab = "COR")
```


### hist (G + Micro -> Met) (2020->2020)
```{R,fig.dim = c(5,3)}
predmet20 <- read.csv(here("2020", "20f20_predmet_GM_blup_OneOut_c.csv"), row.names = 1)
cor<- cor(predmet20,met20.cd)
Predmet_20from20_COR_GM_C<- diag(cor)
hist(Predmet_20from20_COR_GM_C,xlim =c(-1,1),ylim=c(0,100),breaks=20,xlab = "COR")
```
