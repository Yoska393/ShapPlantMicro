...
## 2.1 Model Build for 2019 Met Prediction 
Oneout 45 ver2
Inter and inner year prediction by BLUP
Drought and Control
We tried the following models     
- G -> Met  (2020->2019)  
- G + Micro -> Met (2020->2019)  
- G + Micro -> Met (2019->2019)  
...
```{R,eval = TRUE}
write.csv(predmetgm,here("out","19f20_predmet_GM_blup_OneOut.csv"))
```
...
csv
```{R,eval = TRUE}
write.csv(predmetg,here("out","19f20_predmet_G_blup_OneOut.csv"))
```
...
csv
```{R,eval = TRUE}
write.csv(predmetg,here("out","19f20_predmet_M_blup_OneOut.csv"))
```
...
csv
```{R,fig.dim = c(5,3)}
write.csv(predmetg,here("out","19f19_predmet_GM_blup_OneOut.csv"))
```
...
csv
```{R,fig.dim = c(5,3)}
write.csv(predmetg,here("out","19f19_predmet_G_blup_OneOut.csv"))
```
...
csv
```{R,fig.dim = c(5,3)}
write.csv(predmetg,here("out","19f19_predmet_M_blup_OneOut.csv"))
```
...
```{R,eval = TRUE}
write.csv(predmetgm,here("out","19f20_predmet_GM_blup_OneOut_c.csv"))
```
...
csv
```{R,eval = TRUE}
write.csv(predmetg,here("out","19f20_predmet_G_blup_OneOut_c.csv"))
```
...
csv
```{R,eval = TRUE}
write.csv(predmetg,here("out","19f20_predmet_M_blup_OneOut_c.csv"))
```
...
csv
```{R,fig.dim = c(5,3)}
write.csv(predmetg,here("out","19f19_predmet_GM_blup_OneOut_c.csv"))
```
...
csv
```{R,fig.dim = c(5,3)}
write.csv(predmetg,here("out","19f19_predmet_G_blup_OneOut_c.csv"))
```
...
csv
```{R,fig.dim = c(5,3)}
write.csv(predmetg,here("out","19f19_predmet_M_blup_OneOut_c.csv"))
```
