...
# We create folds on row indices; later we’ll remap after dropping NAs.
...
```{r,eval=F}
saveRDS(cor.summary,here("out","markersize.rds"))
```
...
cor.summary <- readRDS(here("out","markersize.rds"))
